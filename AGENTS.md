...
A股股票分析 OpenCode Skills 集合，基于 akshare 数据源。包含 12 个独立 Skill，可单独使用也可组合输出完整报告。
...
| **入口层** | `core/src/skills/` | 15 个 skill 的 `main.py`，参数解析 + 格式化输出 |
...
│       │       └── skills/              # 16 个 Skill 入口（薄封装层）
│       │           ├── stock-analyzer/main.py
│       │           ├── financial-health/main.py
...
│       │           ├── shareholder-analyzer/main.py
│       │           ├── shareholder-deep/main.py
│       │           ├── report-exporter/main.py
